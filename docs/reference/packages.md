...
| `@btravstack/prisma`          | `@btravstack/core`, `@btravstack/config`, `@btravstack/di`, `unthrown`, `@prisma/adapter-pg` — and `@prisma/instrumentation` as an **optional** peer, behind the `/otel` subpath                                                 |
