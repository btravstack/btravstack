...
| ----------------- | --------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `env`             | `Environment`               | `process.env`                      | The environment the graph is configured from, provided as the `Env` port; also where the kernel reads its own `PROBE_PORT`, `PRE_DRAIN_DELAY_MS`, `DRAIN_TIMEOUT_MS` and `STOP_TIMEOUT_MS`. A test hands in a record.                                                                                                                                                                                                                                                                   |
