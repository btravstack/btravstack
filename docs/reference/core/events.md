---
title: Kernel events
description: The ten KernelEvent variants with their fields, the EventSink type, and stderrSink's one-JSON-line format including how it renders an Error cause.
---
...
> **Reference.** The ten events the kernel emits, the sink type that receives
