...
- b468999: Closed the three open bugs from the 2026-09-16 audit. Each was silent: a
...
- Updated dependencies [6b11977]
- Updated dependencies [b468999]
  - @btravstack/contract@0.16.0
...
- 58b03ba: Closed four ways the HTTP auth and contract surfaces reported something they
  were not.
...
- 2ee30d9: `@btravstack/http-server` states its resolution requirement: `node16` or
  `nodenext`.
...
- Updated dependencies [5f5efef]
- Updated dependencies [f0686e1]
