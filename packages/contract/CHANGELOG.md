...
- 6b11977: **New: `keyset(request)`, the keyset pagination an adapter would otherwise
...
- 3f48955: `@btravstack/contract` is the contract tier rather than an auth-only package:
